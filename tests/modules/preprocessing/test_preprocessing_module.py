...
def test_preprocessing_module_run_success(preprocessing_module):
    ...
    assert "ctr" in updated_ctx.processed_df.columns
    assert updated_ctx.processed_df.iloc[0]["ctr"] == 0.1

def test_preprocessing_module_missing_raw_df(preprocessing_module):
...
def test_preprocessing_module_save(preprocessing_module):
