...
def test_analysis_endpoint(mock_enrichment_module, mock_analysis_module):
...
def test_recommendation_endpoint_auto_analysis(mock_enrichment_module, mock_analysis_module, mock_recommendation_module):
    # Mock enrichment return value
    from src.core.execution_context import ExecutionContext
...
def test_recommendation_endpoint_with_analysis(mock_enrichment_module, mock_analysis_module, mock_recommendation_module):
    # Mock enrichment return value
    from src.core.execution_context import ExecutionContext
    mock_context_enriched = ExecutionContext()
    mock_context_enriched.enriched_data = {"campaign_data": {"enriched": True}}
...
def test_analysis_endpoint_error(mock_analysis_module):
