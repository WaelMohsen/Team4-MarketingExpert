...
def test_Run_ShouldCallEvaluatorsCorrectly_WhenAllDataIsPresent(evaluation_module):
...
def test_Save_ShouldPersistEvaluationResults_WhenOutputDirectoryExists(evaluation_module):
