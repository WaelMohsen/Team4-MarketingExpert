...
def test_Run_ShouldGenerateResults_WhenDataIsPresent(analysis_module):
...
def test_Run_ShouldRaiseValueError_WhenEnrichedDataIsMissing(analysis_module):
...
def test_Save_ShouldPersistResultsToJson_WhenOutputDirectoryExists(analysis_module):
