...
def test_GetGoalMetrics_ShouldReturnCorrectKeys_WhenSpecificGoalIsProvided():
...
def test_GetObjectivePrompt_ShouldReturnCorrectPath_WhenGoalIsMapped():
...
def test_BuildAnalysisPrompt_ShouldInjectGoalInstructions_WhenProvided():
